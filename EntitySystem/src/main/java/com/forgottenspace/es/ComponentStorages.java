...
final class ComponentStorages {
    ...
    private boolean isComponentTypeRegistered(Class<? extends EntityComponent> componentType) {
    ...
    public void storeComponentForEntity(Long entityId, EntityComponent entityComponent) {
        if (isComponentTypeRegistered(entityComponent.getClass())) {
    ...
    private ComponentStorage getComponentStorage(Class<? extends EntityComponent> componentType) {
        return registeredTypesWithStorage.get(componentType);
    }

    private void componentTypeNotRegistered(Class<? extends EntityComponent> componentType) {
